...
function Cobranzas() {
  return (
    <div className="body-proveedores">
      <div className="container-nosotros-1 imgBackground-cobranzas">
        <div className="container-nosotros-1-header">
          <h1>Cobranzas Regulares a Medida para su Negocio</h1>
        </div>
      </div>
      ...
      <div className="body-proveedores-2">
        <div className="container-proveedores-1">
          ...
          <div className="container-arrow-text-proveedores">
            ...
            <Link className="link-proveedores">
              Seguimiento de deducciones y documentacionde respaldo
            </Link>
          </div>
          ...
          <div className="container-arrow-text-proveedores">
            ...
            <Link className="link-proveedores">
              Administracion y custodia de valores
            </Link>
          </div>
          ...
          <div className="container-arrow-text-proveedores">
            ...
            <Link className="link-proveedores">
              Control de morosidad y alerta temprana
            </Link>
          </div>
        </div>
      </div>
